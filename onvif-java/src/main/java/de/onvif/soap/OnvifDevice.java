...
public class OnvifDevice {
    ...
    public static String replaceHostInUrl(String url, URL newAuthority) {
        if (url == null || newAuthority == null) {
            return url;
        }

        String newHost = newAuthority.toExternalForm();
    ...
    public JaxWsProxyFactoryBean getServiceProxy(BindingProvider servicePort, String serviceAddr) {
        ...
        if (serviceAddr != null) proxyFactory.setAddress(replaceHostInUrl(serviceAddr, url));
